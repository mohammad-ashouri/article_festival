        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 700px">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-striped" id="myTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <p style="font-size: 13px; font-weight: bold">اثربخشی و میزان تاثیر گذاری در حل مشکلات
                                    علمی
                                    و کاربردی</p>
                            </td>
                            <td class="text-center" style="text-align: center">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" aria-hidden="true" id="printEjmaliButton"
    ...
    <div class="modal fade" id="tafsiliModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="width: 800px">
                    ...
                    <table class="table table-bordered table-striped" id="myTable">
                            ...
                            <tr>
                                ...
                                <td style="width: 150px;">
                                    ...
                                    <label style="font-size: 13px"
                                           id="r<?php echo $Tafsili_Form['id']; ?>Tafsili"></label>
                                </td>
                            </tr>
                            <tr>
                                <th>
                        ...
                        <tr>
                            <th colspan="4" style="text-align: center; font-weight: normal; font-size: 12px">
                                امتیاز ویژه: امتیاز این شاخص جزء 100 امتیاز فرم نیست؛ ولی امتیازی که در این شاخص کسب می
                                شود،
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" aria-hidden="true" id="printTafsiliButton"
                            data-bs-dismiss="modal">چاپ کارنامه
                    </button>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    if (mysqli_num_rows($query) < 1) {
                        ...
                        <div style="margin-bottom: 20px; overflow-x: auto">
                            ...
                            <select id="searchInput2" class="form-control select2"
                                    style="width: 20%;display: inline-block;margin-bottom: 8px">
                                <option value="" selected>بدون فیلتر</option>
                                <?php
                                $groups = mysqli_query($connection_maghalat, "select * from scientific_group order by name asc");
                            ...
                            foreach ($query as $articles) :
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        $pagesNumber = $articleInfo['number_of_page_in_mag_to'] - $articleInfo['number_of_page_in_mag_from'];
                                        echo "$articleInfo[subject] <br> نویسنده:  $author[0] <br> نشریه: $magInfo[publication_period] $magInfo[name] <br> تعداد صفحات: $pagesNumber"; ?></td>
                                    <td>
                                        <?php
                                        $sg1 = $articleInfo['scientific_group_1'];
                                        $query = mysqli_query($connection_maghalat, "select * from scientific_group where id='$sg1'");
                                        $sg1Info = mysqli_fetch_array($query);
                                        echo $sg1Info['name'];
                                        $sg1Info['name'] = null;
                                        ?>
                                    </td>
                                    <td>
                                        ...
                                        $sg2Info = mysqli_fetch_array($query);
                                        echo @$sg2Info['name'];
                                        $sg2Info['name'] = null;
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        if ($articles['ejmali1_g1_done'] == 1) :
                                            ...
                                            <div class="flex-1 mb-1">
                                                <button type="button"
                                                        class="btn btn-primary d-inline-block getEjmaliPoint"
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ej1g1" data-rate-type="ejmali"
                                        ...
                                        if ($articles['ejmali2_g1_done'] == 1) :
                                            ...
                                            <div class="flex-1 mb-1">
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ej2g1" data-rate-type="ejmali"
                                                        data-target="#ejmaliModal">
                                                    اجمالی دوم گروه اول
                                                </button>
                                            </div>
                                        ...
                                        if ($articles['ejmali3_g1_done'] == 1) :
                                            ...
                                            <div class="flex-1 mb-1">
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ej3g1" data-rate-type="ejmali"
                                                        data-target="#ejmaliModal">
                                                    اجمالی سوم گروه اول
                                                </button>
                                            </div>
                                        ...
                                        if ($articles['ejmali1_g2_done'] == 1) :
                                            ...
                                            <div class="flex-1 mb-1">
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ej1g2" data-rate-type="ejmali"
                                                        data-target="#ejmaliModal">
                                                    اجمالی اول گروه دوم
                                                </button>
                                            </div>
                                        ...
                                        if ($articles['ejmali2_g2_done'] == 1) :
                                            ...
                                            <div class="flex-1 mb-1">
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ej2g2" data-rate-type="ejmali"
                                                        data-target="#ejmaliModal">
                                                    اجمالی دوم گروه دوم
                                                </button>
                                            </div>
                                        ...
                                        if ($articles['ejmali3_g2_done'] == 1) :
                                            ...
                                            <div class="flex-1 mb-1">
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ej3g2" data-rate-type="ejmali"
                                                        data-target="#ejmaliModal">
                                                    اجمالی سوم گروه دوم
                                                </button>
                                            </div>
                                        ...
                                        if ($articles['tafsili1_done'] == 1) :
                                            ...
                                            <div>
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ta1" data-rate-type="tafsili"
                                        ...
                                        if ($articles['tafsili2_done'] == 1) : ?>
                                            <div>
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ta2" data-rate-type="tafsili"
                                                        data-target="#tafsiliModal">
                                                    تفصیلی دوم
                                                </button>
                                            </div>
                                        ...
                                        if ($articles['tafsili3_done'] == 1) :
                                            ...
                                            <div>
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-post-id="<?php echo $articles['article_id'] ?>"
                                                        data-rate-level="ta3" data-rate-type="tafsili"
                                                        data-target="#tafsiliModal">
                                                    تفصیلی سوم
                                                </button>
                                            </div>
