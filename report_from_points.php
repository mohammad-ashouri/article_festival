    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width: 700px">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" aria-hidden="true" id="printEjmaliButton" data-bs-dismiss="modal">چاپ کارنامه
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="tafsiliModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="width: 800px">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" aria-hidden="true" id="printTafsiliButton" data-bs-dismiss="modal">چاپ کارنامه
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="card card-success">
        <form method="post">
            <div class="card-header d-flex ">
                ...
                <select class="form-control w-25 " required title="دوره را انتخاب کنید" id="festival_id" name="festival_id">
                    <option value="" selected disabled>انتخاب کنید</option>
                    <?php
                    $query = mysqli_query($connection_maghalat, 'select * from festival order by id ');
                    foreach ($query as $festival) :
                    ?>
                        <option <?php if (@$_POST['festival_id'] == $festival['id']) echo 'selected' ?> value="<?php echo $festival['id'] ?>"><?php echo $festival['name']; ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="card-body">
                ...
                ?>
                    <div style="margin-bottom: 20px; overflow-x: auto">
                        ...
                        <select id="searchInput1" class="form-control select2" style="width: 20%;display: inline-block;margin-bottom: 8px">
                        ...
                        <select id="searchInput2" class="form-control select2" style="width: 20%;display: inline-block;margin-bottom: 8px">
                            <option value="" selected>بدون فیلتر</option>
                            <?php
                            $groups = mysqli_query($connection_maghalat, "select * from scientific_group order by name asc");
                            foreach ($groups as $Group) {
